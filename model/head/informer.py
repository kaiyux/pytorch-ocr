...
class InformerEncoderModel(BaseModel):
    def __init__(self, num_chars,
                 d_model=512, n_heads=8, e_layers=3, enc_in=512, factor=5, d_ff=512,
    ...
    def forward(self, x_enc, enc_self_mask=None):
        ...
        out = self.linear(enc_out)  # (S, N, E) -> (S, N, C)
